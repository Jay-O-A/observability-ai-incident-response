...
![Prometheus UI showing targets and scrape status](docs/images/prometheus-running.png)
...
![Grafana Prometheus data source successfully connected](docs/images/grafana-datasource-prometheus.png)
...
![Grafana dashboard showing request count, errors, and latency](docs/images/grafana-dashboard-panel.png)
...
![Prometheus target page showing node exporter UP](docs/images/node-exporter-dashboard.png)
...
![n8n workflow showing Prometheus query, IF checks, and AI analysis](docs/images/n8n-workflow-overview.png)
...
![IF Node Setup](docs/images/n8n-if-node.png)
...
![OpenAI API Key Account Setup](docs/images/n8n-openai-credentials.png)

![OpenAI Node Setup](docs/images/n8n-openai-node.png)
...
![Slack alert generated by n8n after anomaly detection](docs/images/n8n-slack-message.node.png)
